...
export default function EmptyState({ onReset }: EmptyStateProps) {
  return (
    /*
     * col-span-full stretches this section across all grid columns so it
     * fills the entire job grid area rather than occupying a single cell.
     */
    <section
      aria-label="No results"
      className="col-span-full flex flex-col items-center justify-center py-20 px-4 text-center"
    >
      <div className="w-20 h-20 rounded-full bg-green-50 flex items-center justify-center mb-5" aria-hidden="true">
        <svg className="w-10 h-10 text-[#2E7D32]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
