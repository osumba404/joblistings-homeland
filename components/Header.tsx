        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center gap-2 shrink-0">
            ...
            <div className="hidden sm:block">
              <span className="font-bold text-[#2E7D32] text-lg leading-none block">
                Homeland
              </span>
              <span className="text-[#E65100] text-xs font-medium leading-none">
                Ecosystem Hub
              </span>
            </div>
          </Link>
          ...
          <nav className="hidden md:flex items-center gap-6">
            <Link
              href="/"
              className="text-gray-700 hover:text-[#2E7D32] font-medium transition-colors"
            >
              Home
            </Link>
            <Link
